...
## 2026-07-07 — Inclusão da base comercial parcial de julho

**Período analisado:** Julho de 2026, parcial  
**Arquivo-base:** `Relatório Marketing 2026.xlsm`  
**Fontes:** `CLOSER JUNHO FINALIZADA.xlsx` e `CLOSER JULHO.xlsx`  
**Arquivo entregue:** `Relatório Marketing 2026 - Julho Parcial 2026-07-07.xlsx`

### Alterações
- Criada a aba `MARKETING JULHO` com o mesmo layout da aba de junho.
- Inseridos somente dados comerciais auditáveis.
- Tráfego, MQL, agendamentos, origem e orgânico foram mantidos como pendentes.
- Inserida a base detalhada dos 11 pacientes da Closer.
- Registradas divergências entre o dashboard da Closer e a soma linha a linha.

### Dados confirmados
- Pacientes atendidos: 11
- Pacientes fechados: 8
- Pacientes em negociação: 3
- Conversão auditada: 72,73%
- Receita fechada comercial: R$ 60.592,01
- Pipeline auditado: R$ 27.323,24
- Faturamento de consultas de primeira consulta: R$ 3.800,00
- Tratamentos fechados na primeira consulta: R$ 17.429,91

### Divergências
- Pipeline do dashboard: R$ 27.355,64
- Pipeline linha a linha: R$ 27.323,24
- Diferença: R$ 32,40
- Conversão do dashboard: 70,00%
- Conversão auditada: 72,73%

### Decisão
- Usar a soma linha a linha para pipeline e conversão.
- Não calcular CAC ou ROI antes do recebimento dos dados de marketing.
- Não tratar atendimentos da Closer como agendamentos sem reconciliação com a agenda.


---

## 2026-07-07 — Auditoria final em cinco passagens

**Arquivo oficial:** `Relatório Marketing 2026.xlsx`

### Correções confirmadas
- Junho: 1.428 formulários válidos, 1.371 pessoas únicas, 204 MQLs por submissão e 199 pessoas únicas MQL.
- Duplicidades de junho: 53 pessoas repetidas e 57 envios excedentes.
- Julho 01–07: 314 formulários válidos, 311 pessoas únicas, 51 MQLs e 49 pessoas únicas MQL.
- Rankings de tráfego de junho e julho recalculados diretamente pelos exports mais recentes.
- Meta junho mantém separados: 1.401 leads do baseline, 1.525 Leads do export e 1.327 Resultados `leadgen.other`.
- Julho mantém a divergência de atribuição: 318 resultados em campanhas, 316 em conjuntos e 315 em anúncios.
- Orgânico de junho e julho revisado; Natuá julho permanece 01–06/07 sem estimativa do dia 7.
- Junho comercial mantém o dashboard manual aprovado; Closer bruto e Support ficam registrados como fontes separadas.

### Validação
- Cinco passagens de auditoria concluídas: estrutura, tráfego, MQL/duplicidade, comercial/Support e orgânico.
- Exportação e reimportação testadas.
- Nenhum erro de fórmula identificado.
- Aba `AUDITORIA FINAL` adicionada com rastreabilidade das divergências.
